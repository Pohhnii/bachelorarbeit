...
fun createLeNet5Js(): Model {
    val model = Model()
    model.add(ConvLayerJs(kernelSize = 5, featureMaps = 6, padding = 2)) // Result: 28x28x6
    ...
    model.add(ConvLayerJs(kernelSize = 5, featureMaps = 16, padding = 0)) // Result: 10x10x16
